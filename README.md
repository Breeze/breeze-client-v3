...
| [DOCS.md](./DOCS.md) | **Building and viewing the docs** — the guides and the API reference |
| [BUILD-AND-PACK.md](./BUILD-AND-PACK.md) | **Packing the library and trying it in another app** without publishing |
