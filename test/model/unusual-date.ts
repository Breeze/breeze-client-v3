...
/**
 * UnusualDate:#Foo - the entity type, queried as `UnusualDates`.
 * Key: id.
 *
 * Methods, getters and unmapped properties added below survive a regeneration; see
 * ./README.md.
 */
export class UnusualDate extends EntityBase {
  declare id: number;  // @generated
  declare creationDate: Date;  // @generated
  declare dateOnly: Date;  // @generated
  declare modificationDate: Date;  // @generated
  declare creationDate2: Date;  // @generated
  declare modificationDate2: Date;  // @generated
  declare timeOnly: string;  // @generated
}
