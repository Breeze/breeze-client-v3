...
/**
 * Geospatial:#Foo - the entity type, queried as `Geospatials`.
 * Key: id.
 *
 * Methods, getters and unmapped properties added below survive a regeneration; see
 * ./README.md.
 */
export class Geospatial extends EntityBase {
  declare id: number;  // @generated
  declare geometry1: any;  // @generated
  declare geography1: any;  // @generated
}
