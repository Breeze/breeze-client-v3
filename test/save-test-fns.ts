import { EntityManager, AutoGeneratedKeyType, Entity, Predicate, FilterQueryOp, EntityQuery, SaveOptions, MetadataStore } from '../src/breeze';
import { TestFns, JsonObj } from './test-fns';
import { Customer, Employee } from './model';
...
export class SaveTestFns {
  ...
  static newEntityManager() {
    ...
    const territoryType = testMs.getAsEntityType("Territory");
  ...
  static async cleanup() {
    ...
    const p = pc("companyName", FilterQueryOp.StartsWith, "Test")
        .or(pc("companyName", FilterQueryOp.StartsWith, "foo"));
    ...
    const p2 = pe('lastName', FilterQueryOp.StartsWith, 'Test')
        .and(pe('firstName', FilterQueryOp.StartsWith, 'Test'));
