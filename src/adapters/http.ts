import { BreezeConfig, config } from '../config/config.js';
import { core } from '../core/core.js';
import { appendQueryStringParameter, encodeParams } from './adapter-core.js';
import type { AjaxAdapter, AjaxConfig, AjaxRequestInterceptor, BreezeFetch } from '../config/interface-registry.js';
import type { HttpResponse } from '../manager/entity-manager.js';
