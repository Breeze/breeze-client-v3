 ...
 *
 * Copyright 2015-2026 IdeaBlade, Inc.  All Rights Reserved.
    ...
    function processSettings(settings: any) {
      ...
      if (data) {
        ...
        if (parameters.$encoding === 'JSON') {
          // JSON encoding
          settings.processData = false; // don't form-encode the body
        ...
        // must be null or the ajax adapter won't see settings.data
