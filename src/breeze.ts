...
import { InterfaceRegistry, AjaxAdapter, AjaxConfig, BreezeFetch, DataServiceAdapter, ModelLibraryAdapter, ChangeRequestInterceptor, UriBuilderAdapter, InterfaceRegistryConfig, AjaxRequestInterceptor } from './interface-registry';
...
import { configureBreeze, BreezeSetupOptions, AdapterRegistration, AjaxAdapterRegistration } from './configure';
